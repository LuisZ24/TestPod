...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/LuisZ24/TestPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'LuisZ24' => 'luis.zatarain@neoris.com' }
  s.source           = { :git => 'https://github.com/LuisZ24/TestPod.git', :tag => s.version.to_s }
